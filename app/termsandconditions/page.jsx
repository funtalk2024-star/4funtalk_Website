...
const toc = [
  ...
  { id: "electronic-record", label: "11. Electronic Record" },
      ...
      <div className="px-5 pb-24 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24">
        <div className="mx-auto w-full max-w-7xl">
          ...
          <Section id="the-service" title="2. The Service">
            ...
            <p>
              <strong>Note:</strong> The consultants available in the App
              are independent, third-party contract workers and are not
          ...
          <Section id="refunds" title="5. Refunds">
            ...
            <ul className="list-disc space-y-1.5 pl-5">
              <li>
                <strong>Non-refundable:</strong> Once coins are purchased,
                they are non-refundable. You can use your coins for services
                within the App.
              </li>
              <li>
                <strong>Technical errors:</strong> In case of payment gateway
                errors (for example, being charged multiple times for a
                single purchase), contact support at{" "}
                <a
                  href={`mailto:${CONTACT_EMAIL}`}
                  className="font-medium text-[#e5273b] hover:underline"
                >
                ...
                . Valid claims will be processed within 7 working days.
              </li>
              <li>
                <strong>Finality of transactions:</strong> Refunds are only
                provided for acknowledged technical errors, not for
                user-initiated actions. We encourage you to fully utilize
                your purchased coins before deciding to close your account.
              </li>
            </ul>
          </Section>
          ...
          <Section id="acceptable-use" title="6. Acceptable Use">
            ...
            <ul className="list-disc space-y-1.5 pl-5">
              ...
              <li>Engage in defamatory behavior or share misleading information.</li>
            </ul>
            <p>
          ...
          <Section id="governing-law" title="10. Governing Law and Jurisdiction">
            <p>
              ...
              courts in Kozhikode, Kerala, India.
            </p>
          </Section>

          <Section id="electronic-record" title="11. Electronic Record">
            <p>
              ...
              Digital Media Ethics Code) Rules, 2021, as amended from time
              to time. This electronic record is generated by a computer
